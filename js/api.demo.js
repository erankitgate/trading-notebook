...
function build() {
  ...
  const plans = [
    { id: uid(), user_id: USER.id, date: today(), instrument: 'NIFTY 23250 CE (2-week expiry)', instrument_key: 'NSE_INDEX|Nifty 50', side: 'Buy', entry: 186.69, stop: null, target: 265, qty: 910, strike: 23250, option_type: 'CE', expiry: addDays(today(), 14), iv: 8.6, condition: 'FOMO on crude falling — not a planned trade; averaged with account money', status: 'live', fill: 186.69, sort: 0, note: 'No stop set at entry. See the payoff grid before deciding.' },
